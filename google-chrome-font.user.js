...
var css = [
  ...
  '}',
  '@import url(https://fonts.lug.ustc.edu.cn/css?family=Noto+Sans+SC);',
  //'body {font-family: "Only Emoji", Helvetica, "Noto Sans SC", sans-serif !important; font-size: 1.1rem !important; line-height: 130% !important;}'].join("\n")
  'body {font-family: "Only Emoji", Helvetica, "Noto Sans SC", "Source Han Sans CN", "Microsoft YaHei", "WenQuanYi Micro Hei", sans-serif !important; font-size: 16px !important; line-height: 150% !important; }'].join("\n")
